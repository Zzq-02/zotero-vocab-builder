...
const UI_TEXT: Record<UILanguage, Record<string, string>> = {
  ...
  "en-US": {
    ...
    "shortcut.retryLabel": "Retry translations:",
    ...
    "notify.needOnline": "This action requires an internet connection",
    "notify.batchAdded":
    ...
    "menu.retry": "Retry Pending Translations",
